...
public class MapEditorManager : MonoBehaviour, IModalFocusHolder
{
    ...
    public void PressedRockBrushButton()
    {
        MapManager.singleton.SelectRockBrush();
        SetTerrainBrushesPanelActive(false);
    }

    public void PressedTreeBrushButton()
    {
        MapManager.singleton.SelectTreeBrush();
        SetTerrainBrushesPanelActive(false);
    }

    public void PressedDesertBrushButton()
    {
        MapManager.singleton.SelectDesertBrush();
        SetTerrainBrushesPanelActive(false);
    }

    public void PressedWastelandBrushButton()
    {
        MapManager.singleton.SelectWastelandBrush();
        SetTerrainBrushesPanelActive(false);
    }

    public void PressedMarshBrushButton()
    {
        MapManager.singleton.SelectMarshBrush();
        SetTerrainBrushesPanelActive(false);
    }

    public void PressedWaterBrushButton()
    {
        MapManager.singleton.SelectWaterBrush();
        SetTerrainBrushesPanelActive(false);
    }

    public void PressedRuinsBrushButton()
    {
        MapManager.singleton.SelectRuinsBrush();
        SetTerrainBrushesPanelActive(false);
    }

    public void PressedMountainBrushButton()
    {
        MapManager.singleton.SelectMountainBrush();
        SetTerrainBrushesPanelActive(false);
    }

    public void PressedJungleBrushButton()
    {
        MapManager.singleton.SelectJungleBrush();
        SetTerrainBrushesPanelActive(false);
    }

    public void PressedSnowBrushButton()
    {
        MapManager.singleton.SelectSnowBrush();
        SetTerrainBrushesPanelActive(false);
    }

    public void PressedSwampBrushButton()
    {
        MapManager.singleton.SelectSwampBrush();
        SetTerrainBrushesPanelActive(false);
    }
    ...
    public void PressedRedDeploymentZoneBrushButton()
    {
        MapManager.singleton.SelectRedDeploymentZoneBrush();
        CloseSubPanels();
    }

    public void PressedBlueDeploymentZoneBrushButton()
    {
        MapManager.singleton.SelectBlueDeploymentZoneBrush();
        CloseSubPanels();
    }

    public void PressedClearDeploymentZoneBrushButton()
    {
        MapManager.singleton.SelectClearDeploymentZoneBrush();
        CloseSubPanels();
    }

    public void PressedPaveBrushButton()
    {
        MapManager.singleton.SelectPaveBrush();
        CloseSubPanels();
    }

    public void PressedUnpaveBrushButton()
    {
        MapManager.singleton.SelectUnpaveBrush();
        CloseSubPanels();
    }
